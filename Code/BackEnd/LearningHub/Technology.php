...
class Content
{
  ...
  public function getArticlesContent()
  {
    ...
    $sql = "SELECT * FROM content WHERE Type = 'Article' AND CategoryName = 'Technology' ";
    $conn = $this->db->getConnection();
  ...
  public function getVideosContent()
  {
    ...
    // Retrieve file path from the database
    $sql = "SELECT * FROM content WHERE Type = 'Video' AND CategoryName = 'Technology'";
    $conn = $this->db->getConnection();
    $result = $conn->query($sql);
  ...
  public function getRecordsContent()
  {
    ...
    // Retrieve file path from the database
    $sql = "SELECT * FROM content WHERE Type = 'Record' AND CategoryName = 'Technology'";
    $conn = $this->db->getConnection();
    $result = $conn->query($sql);
