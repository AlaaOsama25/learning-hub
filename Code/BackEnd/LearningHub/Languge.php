...
class Content
{
  ...
  public function getArticlesContent()
  {
    ...
    $sql = "SELECT * FROM content WHERE Type = 'Article' AND CategoryName = 'Language' ";
    $conn = $this->db->getConnection();
  ...
  public function getVideosContent()
  {
    ...
    // Retrieve file path from the database
    $sql = "SELECT * FROM content WHERE Type = 'Video' AND CategoryName = 'Language'";
    $conn = $this->db->getConnection();
    $result = $conn->query($sql);
  ...
  public function getRecordsContent()
  {
    ...
    // Retrieve file path from the database
    $sql = "SELECT * FROM content WHERE Type = 'Record' AND CategoryName = 'Language'";
    $conn = $this->db->getConnection();
    $result = $conn->query($sql);
...
if (isset($_POST['followBtn'])) {
  $followCategory->follow($_SESSION['userID'], "Language");
}

if (isset($_POST['unfollowBtn'])) {
  $followCategory->unfollow($_SESSION['userID'], "Language");
}
